...
import TataZestImage from '/src/assets/Car Png/Tatazest.png';
import SumoDiImage from '/src/assets/Car Png/sumodi.png';
import ForceTravellerImage from '/src/assets/Car Png/Travaller.png';
import ToyotaRumionImage from '/src/assets/Car Png/Rumion.png';

export const carsList = [
  {
    name: "Tata Zest",
    description: "A compact sedan perfect for city travel with spacious interiors and efficient fuel economy.",
    image: TataZestImage,
    customerBenefits: [
  ...
  {
    name: "Toyota Rumion",
    description: "A premium MPV perfect for long journeys, combining luxury, style, and performance.",
  ...
  {
    name: "Sumo Di",
    description: "A rugged SUV ideal for group travel and off-road adventures with ample seating capacity.",
    image: SumoDiImage,
    customerBenefits: [
  ...
  },
  {
    ...
    description: "A versatile van designed for large groups, offering comfort and ample luggage space.",
